...
{
	public class DocumentInstructionRepository : Repository<DocumentTypePerDiem>, IDocumentInstructionRepository
	{
		private readonly MainDbContext _context;

		public DocumentInstructionRepository(MainDbContext context) : base(context)
		{
			_context = context;
		}
