...
{
	public class ReportingRequirementRepository : Repository<ReportingTypePerDiem>, IReportingRequirementRepository
	{
		private readonly MainDbContext _context;

		public ReportingRequirementRepository(MainDbContext context) : base(context)
		{
			_context = context;
		}
