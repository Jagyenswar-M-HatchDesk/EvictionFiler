...
{
    public class ExemptionBasicsRepository : ReadRepository<ExemptionBasic>, IExemptionBasicsRepository
    {
        private readonly IDbContextFactory<MainDbContext> _contextFactory;

        public ExemptionBasicsRepository(IDbContextFactory<MainDbContext> contextFactory) : base(contextFactory)
        {
