...
builder.Services.AddScoped<IReportingRequirementRepository, ReportingRequirementRepository>();
builder.Services.AddScoped<IDocumentInstructionRepository, DocumentInstructionRepository>();
